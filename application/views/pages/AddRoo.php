<?php
	...
	{
?>
		<form method="post" action="<?= base_url() ?>MasterAdmin/do_Adds?tipe=Room" class="form-auth-large" >
<?php
	}
	else
	{
		?>
		<form method="post" action="<?= base_url() ?>dothat/s?tipe=Room" class="form-auth-large" >
		<?php
	}
?>
<div class="panel">
...
<div class="vertical-align-middle">
    ...
    <div class="panel panel-default">
		<div class="panel-body">
			<table>
				<tr>
					<td width="130px">Nama Room</td>
					<td><input type="text" name="NewRoom" class="form-control"></td>
				</tr>
			</table>
